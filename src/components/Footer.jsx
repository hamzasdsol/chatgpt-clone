    ...
    <div className='bg-white py-4 mt-4'>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="relative w-full md:w-4/5 lg:w-3/4 flex">
            <textarea
              className="w-full  border-2 border-gray-200 rounded-full px-12 pt-6 resize-none bg-gray-200 text-black text-xl placeholder-gray-500 placeholder:text-xl focus:outline-none"
