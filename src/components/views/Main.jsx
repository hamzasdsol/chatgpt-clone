      ...
      <section className="text-gray-600 body-font mt-2">
        <div className="container px-5 py-24 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4"> 
              <div className="relative flex flex-col items-center text-center bg-white rounded-2xl shadow-md p-3 h-48"> 
                <img 
                ...
                <div className="flex flex-col items-center justify-center text-black bg-white bg-opacity-90 rounded-2xl p-3"> 
                  <p className="text-lg font-semibold">What's in my Kitchen</p>
                </div>
              </div>
            </div>
            <div className="p-4"> 
              <div className="relative flex flex-col items-center text-center bg-white rounded-2xl shadow-lg p-3 h-48">
                <img 
                  className="rounded-full w-6 h-6 object-cover object-center mb-2" 
                  src={penImage} 
                  alt="Card Image"
                />
                <div className="flex flex-col items-center justify-center text-black bg-white bg-opacity-90 rounded-2xl p-3"> 
                  <p className="text-lg font-semibold">Content Calendar</p> 
                </div>
              </div>
            </div>
            <div className="p-4">
              <div className="relative flex flex-col items-center text-center bg-white rounded-2xl shadow-lg p-3 h-48"> 
                ...
                />
                <div className="flex flex-col items-center justify-center text-black bg-white bg-opacity-90 rounded-2xl p-3"> 
                  <p className="text-lg font-semibold">Plan a relaxing day</p> 
                </div>
              </div>
            </div>
            <div className="p-4">
              <div className="relative flex flex-col items-center text-center bg-white rounded-2xl shadow-lg p-3 h-48"> 
                ...
                />
                <div className="flex flex-col items-center justify-center text-black bg-white bg-opacity-90 rounded-2xl p-3"> 
                  <p className="text-lg font-semibold">Pick Outfit to look good on Camera</p> 
                </div>
              </div>
            </div>
          </div>
